...
namespace XVM.Runtime.XVM.Runtime.RTProtection
{
	...
	{
		public static bool AntiDumpIsRunning { get; private set; }

		public unsafe static void Initialize()
		{
			if (AntiDumpIsRunning)
			{
				return;
			}
			...
			ptr2 = ptr3 = ptr2 + 4 + num2;
			byte* ptr4 = stackalloc byte[11];
			uint lpflOldProtect;
			if (module.FullyQualifiedName[0] != '<')
			{
				NativeMethods.VirtualProtect(ptr2 - 16, 8u, 64u, out lpflOldProtect);
				*((int*)ptr2 - 3) = 0;
				...
				*((int*)ptr2 - 4) = 0;
				if (*((uint*)ptr2 - 30) != 0)
				{
					...
					NativeMethods.VirtualProtect(ptr8, 11u, 64u, out lpflOldProtect);
					*(int*)ptr4 = 1818522734;
					...
					NativeMethods.VirtualProtect(ptr9, 11u, 64u, out lpflOldProtect);
					*(int*)ptr4 = 1866691662;
				...
				for (int k = 0; k < num; k++)
				{
					NativeMethods.VirtualProtect(ptr2, 8u, 64u, out lpflOldProtect);
					Marshal.Copy(new byte[8], 0, (IntPtr)ptr2, 8);
					ptr2 += 40;
				}
				NativeMethods.VirtualProtect(ptr5, 72u, 64u, out lpflOldProtect);
				byte* ptr10 = ptr + (uint)((int*)ptr5)[2];
				*(int*)ptr5 = 0;
				((int*)ptr5)[1] = 0;
				((int*)ptr5)[2] = 0;
				((int*)ptr5)[3] = 0;
				NativeMethods.VirtualProtect(ptr10, 4u, 64u, out lpflOldProtect);
				*(int*)ptr10 = 0;
				ptr10 += 12;
				ptr10 += (uint)*(int*)ptr10;
				ptr10 = (byte*)((long)ptr10 + 7L & -4);
				ptr10 += 2;
				ushort num3 = *ptr10;
				ptr10 += 2;
				for (int l = 0; l < num3; l++)
				{
					NativeMethods.VirtualProtect(ptr10, 8u, 64u, out lpflOldProtect);
					ptr10 += 4;
					ptr10 += 4;
					for (int m = 0; m < 8; m++)
					{
			...
			{
				uint num4 = *((uint*)ptr2 - 4);
				uint num5 = *((uint*)ptr2 - 30);
				...
				for (int n = 0; n < num; n++)
				{
					...
					Marshal.Copy(new byte[8], 0, (IntPtr)ptr2, 8);
					array[n] = ((uint*)ptr2)[3];
					array2[n] = ((uint*)ptr2)[2];
					array3[n] = ((uint*)ptr2)[5];
					ptr2 += 40;
				}
				if (num5 != 0)
				{
					...
					NativeMethods.VirtualProtect(ptr + num9, 11u, 64u, out lpflOldProtect);
					*(int*)ptr4 = 1818522734;
					((int*)ptr4)[1] = 1818504812;
					((short*)ptr4)[4] = 108;
					ptr4[10] = 0;
					...
					NativeMethods.VirtualProtect(ptr + num11, 11u, 64u, out lpflOldProtect);
					*(int*)ptr4 = 1866691662;
					((int*)ptr4)[1] = 1852404846;
					((short*)ptr4)[4] = 25973;
					ptr4[10] = 0;
				...
				byte* ptr13 = ptr + num4;
				NativeMethods.VirtualProtect(ptr13, 72u, 64u, out lpflOldProtect);
				uint num16 = ((uint*)ptr13)[2];
				...
				*(int*)ptr13 = 0;
				...
				NativeMethods.VirtualProtect(ptr14, 4u, 64u, out lpflOldProtect);
				*(int*)ptr14 = 0;
				ptr14 += 12;
				ptr14 += (uint)*(int*)ptr14;
				ptr14 = (byte*)((long)ptr14 + 7L & -4);
				ptr14 += 2;
				ushort num18 = *ptr14;
				ptr14 += 2;
				for (int num19 = 0; num19 < num18; num19++)
				{
					NativeMethods.VirtualProtect(ptr14, 8u, 64u, out lpflOldProtect);
					ptr14 += 4;
					ptr14 += 4;
