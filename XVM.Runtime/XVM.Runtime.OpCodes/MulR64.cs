...
namespace XVM.Runtime.XVM.Runtime.OpCodes
{
	...
	{
		public byte Code => VMInstance.STATIC_Instance.Data.Constants.OP_MUL_R64;
		...
		public void Run(VMContext ctx, out ExecutionState state)
		{
			...
			{
				R8 = vMSlot2.R8 * vMSlot.R8
			};
			ctx.Stack[u] = value;
			byte b = (byte)(ctx.Data.Constants.FL_ZERO | ctx.Data.Constants.FL_SIGN | ctx.Data.Constants.FL_UNSIGNED);
