...
{
	public class CallvirtHandler : GInterface0
	{
		...
		public IIROperand Translate(ILASTExpression ilastexpression_0, IRTranslator irtranslator_0)
		{
			...
			if (ilastexpression_0.Prefixes != null && ilastexpression_0.Prefixes[0].OpCode == OpCodes.Constrained)
			{
				instrCallInfo.ConstrainType = (ITypeDefOrRef)ilastexpression_0.Prefixes[0].Operand;
			}
			...
			if (ilastexpression_0.Type.HasValue)
			{
				...
				irtranslator_0.JqX().Add(new IRInstruction(IROpCode.__CALLVIRT)
				{
