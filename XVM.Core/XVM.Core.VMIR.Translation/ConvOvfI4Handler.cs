...
{
	public class ConvOvfI4Handler : GInterface0
	{
		...
		public IIROperand Translate(ILASTExpression ilastexpression_0, IRTranslator irtranslator_0)
		{
			...
			irtranslator_0.JqX().Add(new IRInstruction(IROpCode.PUSH, IRConstant.FromI8(-2147483648L)));
			irtranslator_0.JqX().Add(new IRInstruction(IROpCode.PUSH, IRConstant.FromI8(2147483647L)));
