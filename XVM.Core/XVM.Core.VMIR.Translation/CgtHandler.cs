...
{
	public class CgtHandler : GInterface0
	{
		...
		public IIROperand Translate(ILASTExpression ilastexpression_0, IRTranslator irtranslator_0)
		{
			...
			irtranslator_0.JqX().Add(new IRInstruction(IROpCode.__GETF)
			{
				...
				Operand2 = IRConstant.FromI4((1 << irtranslator_0.Arch.Flags.OVERFLOW) | (1 << irtranslator_0.Arch.Flags.SIGN) | (1 << irtranslator_0.Arch.Flags.ZERO))
			});
