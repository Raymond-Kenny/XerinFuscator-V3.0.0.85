...
{
	public class ConvOvfI2Handler : GInterface0
	{
		public Code ILCode => Code.Conv_Ovf_I2;
		...
		public IIROperand Translate(ILASTExpression ilastexpression_0, IRTranslator irtranslator_0)
		{
			...
			irtranslator_0.JqX().Add(new IRInstruction(IROpCode.PUSH, IRConstant.FromI8(-32768L)));
			irtranslator_0.JqX().Add(new IRInstruction(IROpCode.PUSH, IRConstant.FromI8(32767L)));
