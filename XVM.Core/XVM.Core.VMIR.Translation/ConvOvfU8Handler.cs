...
{
	public class ConvOvfU8Handler : GInterface0
	{
		public Code ILCode => Code.Conv_Ovf_U8;
		...
		public IIROperand Translate(ILASTExpression ilastexpression_0, IRTranslator irtranslator_0)
		{
			...
			irtranslator_0.JqX().Add(new IRInstruction(IROpCode.PUSH, IRConstant.FromI8(long.MaxValue)));
