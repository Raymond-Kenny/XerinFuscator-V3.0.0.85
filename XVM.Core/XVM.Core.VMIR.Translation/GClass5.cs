...
{
	public class GClass5 : GInterface0
	{
		public Code ILCode => Code.Conv_Ovf_U1_Un;
		...
		public IIROperand Translate(ILASTExpression ilastexpression_0, IRTranslator irtranslator_0)
		{
			...
			iRVariable.RawType = irtranslator_0.Context.Method.Module.CorLibTypes.Byte;
			...
			irtranslator_0.JqX().Add(new IRInstruction(IROpCode.PUSH, IRConstant.FromI8(255L)));
