...
{
	public class MulHandler : GInterface1
	{
		...
		public void Translate(IRInstruction irinstruction_0, ILTranslator iltranslator_0)
		{
			...
			{
			case ASTType.I4:
				iltranslator_0.wAE().Add(new ILInstruction(ILOpCode.MUL_DWORD));
				break;
			case ASTType.R4:
				iltranslator_0.wAE().Add(new ILInstruction(ILOpCode.MUL_R32));
				break;
			case ASTType.R8:
				iltranslator_0.wAE().Add(new ILInstruction(ILOpCode.MUL_R64));
				break;
			default:
			...
			case ASTType.Ptr:
			case ASTType.ByRef:
				iltranslator_0.wAE().Add(new ILInstruction(ILOpCode.MUL_QWORD));
				break;
			}
