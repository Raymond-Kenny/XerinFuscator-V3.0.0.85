...
namespace Confuser.DynCipher.Generation
{
	...
	{
		[CompilerGenerated]
		private x86OpCode PCQ;

		[CompilerGenerated]
		private Ix86Operand[] pCF;
		...
		public byte[] Assemble()
		{
			...
			case x86OpCode.MOV:
			{
				...
				{
					byte[] array9 = new byte[2] { 137, 192 };
					array9[1] |= (byte)((int)(Operands[1] as GClass0).Register << 3);
				...
				byte[] array10 = new byte[5] { 184, 0, 0, 0, 0 };
				array10[0] |= (byte)(Operands[0] as GClass0).Register;
				Buffer.BlockCopy(BitConverter.GetBytes((Operands[1] as GClass1).Immediate), 0, array10, 1, 4);
				return array10;
			}
			case x86OpCode.ADD:
				if (Operands.Length == 2)
				{
					if (!(Operands[0] is GClass0) || !(Operands[1] is GClass0))
					{
						...
						byte[] array2 = new byte[6] { 129, 192, 0, 0, 0, 0 };
						array2[1] |= (byte)(Operands[0] as GClass0).Register;
						Buffer.BlockCopy(BitConverter.GetBytes((Operands[1] as GClass1).Immediate), 0, array2, 2, 4);
						return array2;
					}
					byte[] array3 = new byte[2] { 1, 192 };
			...
			case x86OpCode.SUB:
			{
				...
				if (Operands[0] is GClass0 && Operands[1] is GClass0)
				{
					byte[] array12 = new byte[2] { 41, 192 };
					array12[1] |= (byte)((int)(Operands[1] as GClass0).Register << 3);
				...
				byte[] array13 = new byte[6] { 129, 232, 0, 0, 0, 0 };
				array13[1] |= (byte)(Operands[0] as GClass0).Register;
				Buffer.BlockCopy(BitConverter.GetBytes((Operands[1] as GClass1).Immediate), 0, array13, 2, 4);
				return array13;
			}
			case x86OpCode.IMUL:
			{
				...
				byte[] array6 = new byte[6] { 105, 192, 0, 0, 0, 0 };
				array6[1] |= (byte)((int)(Operands[0] as GClass0).Register << 3);
				array6[1] |= (byte)(Operands[0] as GClass0).Register;
				Buffer.BlockCopy(BitConverter.GetBytes((Operands[1] as GClass1).Immediate), 0, array6, 2, 4);
				return array6;
			}
			default:
				throw new NotSupportedException();
			case x86OpCode.NEG:
				if (Operands.Length == 1)
				{
					...
					byte[] array4 = new byte[2] { 247, 216 };
