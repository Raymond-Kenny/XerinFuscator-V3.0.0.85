...
namespace XF
{
	internal class oQg
	{
		private static bool FQp(AssignmentStatement assignmentStatement_0, StatementBlock statementBlock_0)
		{
		...
		public static void MQB(StatementBlock statementBlock_0)
		{
			bool flag;
			do
			{
				...
				{
					flag |= FQp((AssignmentStatement)assignmentStatement_, statementBlock_0);
				}
			}
			while (flag);
		}
